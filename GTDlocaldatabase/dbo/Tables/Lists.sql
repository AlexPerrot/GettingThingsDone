...
GO
CREATE TRIGGER [Lists_delete_trigger] ON dbo.Lists FOR DELETE AS
...
GO
CREATE TRIGGER [Lists_insert_trigger] ON dbo.Lists FOR INSERT AS
...
GO
CREATE TRIGGER [Lists_update_trigger] ON dbo.Lists FOR UPDATE AS
