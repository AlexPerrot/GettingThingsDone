CREATE TABLE [dbo].[Lists_Tasks] (
    ...
    [Owner]   INT NOT NULL,
    CONSTRAINT [PK__Lists_Ta__3214EC070F975522] PRIMARY KEY CLUSTERED ([Id] ASC),
...
GO
CREATE TRIGGER [Lists_Tasks_delete_trigger] ON dbo.Lists_Tasks FOR DELETE AS
...
GO
CREATE TRIGGER [Lists_Tasks_insert_trigger] ON dbo.Lists_Tasks FOR INSERT AS
...
GO
CREATE TRIGGER [Lists_Tasks_update_trigger] ON dbo.Lists_Tasks FOR UPDATE AS
