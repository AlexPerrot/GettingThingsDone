CREATE TABLE [dbo].[Lists_tracking] (
    [Id]                          INT        NOT NULL,
    [Owner]                       INT        NOT NULL,
    ...
    CONSTRAINT [PK_Lists_tracking] PRIMARY KEY CLUSTERED ([Id] ASC, [Owner] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [dbo].[Lists_tracking]([local_update_peer_timestamp] ASC, [Id] ASC, [Owner] ASC);
