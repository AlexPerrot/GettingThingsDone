CREATE TABLE [dbo].[Projects_Lists] (
    ...
    [Owner]      INT NOT NULL,
    CONSTRAINT [PK__Projects__3214EC07173876EA] PRIMARY KEY CLUSTERED ([Id] ASC),
...
GO
CREATE TRIGGER [Projects_Lists_insert_trigger] ON dbo.Projects_Lists FOR INSERT AS
...
GO
CREATE TRIGGER [Projects_Lists_update_trigger] ON dbo.Projects_Lists FOR UPDATE AS
...
GO
CREATE TRIGGER [Projects_Lists_delete_trigger] ON dbo.Projects_Lists FOR DELETE AS
