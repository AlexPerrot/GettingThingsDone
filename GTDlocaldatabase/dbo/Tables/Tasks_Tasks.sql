...
GO
CREATE TRIGGER [Tasks_Tasks_delete_trigger] ON dbo.Tasks_Tasks FOR DELETE AS
...
GO
CREATE TRIGGER [Tasks_Tasks_insert_trigger] ON dbo.Tasks_Tasks FOR INSERT AS
...
GO
CREATE TRIGGER [Tasks_Tasks_update_trigger] ON dbo.Tasks_Tasks FOR UPDATE AS
