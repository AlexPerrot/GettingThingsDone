CREATE TABLE [dbo].[Tasks_Lists_tracking] (
    [Id]                          INT        NOT NULL,
    ...
    CONSTRAINT [PK_Tasks_Lists_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [dbo].[Tasks_Lists_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
