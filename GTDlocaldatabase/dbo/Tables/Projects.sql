...
GO
CREATE TRIGGER [Projects_delete_trigger] ON dbo.Projects FOR DELETE AS
...
GO
CREATE TRIGGER [Projects_insert_trigger] ON dbo.Projects FOR INSERT AS
...
GO
CREATE TRIGGER [Projects_update_trigger] ON dbo.Projects FOR UPDATE AS
