CREATE TABLE [dbo].[Projects_tracking] (
    [Id]                          INT        NOT NULL,
    [Owner]                       INT        NOT NULL,
    ...
    CONSTRAINT [PK_Projects_tracking] PRIMARY KEY CLUSTERED ([Id] ASC, [Owner] ASC)
);
...
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [dbo].[Projects_tracking]([local_update_peer_timestamp] ASC, [Id] ASC, [Owner] ASC);
