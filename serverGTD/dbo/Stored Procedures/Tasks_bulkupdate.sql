CREATE PROCEDURE [Tasks_bulkupdate]
	@sync_min_timestamp BigInt,
	@sync_scope_local_id Int,
	@changeTable [Tasks_BulkType] READONLY
AS
BEGIN
...
(SELECT p.*, t.update_scope_local_id, t.scope_update_peer_key, t.local_update_peer_timestamp FROM @changeTable p LEFT JOIN [Tasks_tracking] t ON p.[Id] = t.[Id]) as changes ON changes.[Id] = base.[Id]
...
UPDATE SET [Title] = changes.[Title], [Description] = changes.[Description], [DueDate] = changes.[DueDate], [CreationDate] = changes.[CreationDate], [Owner] = changes.[Owner]
